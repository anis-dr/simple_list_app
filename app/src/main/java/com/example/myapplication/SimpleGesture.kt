...
abstract class SimpleGesture(context: Context): ItemTouchHelper.SimpleCallback(0, RIGHT or LEFT) {
    ...
    private val deleteIcon = R.drawable.ic_baseline_delete_24_white
    private val archiveIcon = R.drawable.ic_baseline_archive_24_white
